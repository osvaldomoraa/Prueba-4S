                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-7 col-xl-6">
                                <div class="hero-section-heading-box">
                                    <figure class="hero-section-logo-wrapper">
                                        <img class="hero-section-logo" src="assets/img/logos/main-logo.png" alt="">                                
                                    </figure>
                                    <h1 class="hero-section-heading">
                                        Panama is <span class="contrast-word">More</span>
                                    </h1>
                                </div>
                            </div> 
                            ...
                            <div class="col-md-12 col-lg-5 col-xl-4">
                                <p class="standard-text hero-section-text">
                                    Descubre un concepto que te permitirá
                                    aprovechar mejor tus espacios y vivir una 
                                    increíble experiencia <span class="bold-word">More</span>                                  
                                </p>
                            </div>
                            <div class="w-100 d-none d-md-block"></div>
                                ...
                                <div class="hero-section-form-box">
                                    <form>
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="Hero_Form_Name" placeholder="Nombre *" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="Hero_Form_Last_Name" placeholder="Apellido *" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="Hero_Form_Mail" placeholder="Correo *" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="Hero_Form_Phone" placeholder="Telefono *" required>
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control" id="Hero_Form_Interest" required>
                                              <option selected="true" disabled="disabled">Modelo de interes *</option> 
                        ...
                        <div class="row">
                            <div class="col-lg-9 col-xl-7 offset-lg-3 offset-xl-5 background-col">
                                <div class="image-background d-flex">
                                    <img class="single-triangle align-self-end" src="assets/img/polygons/triangle-black-l.png" alt="">                                                
                                </div>
                            </div>
                        </div>                            
                    </div>
                        ...
                        <div class="row">
                            <div class="col-7 offset-0 offset-lg-3 offset-xl-5">
                                <div class="polygon-group-wrapper d-flex">
                                    <img class="polygon-group align-self-end" src="assets/img/polygons/triangle-gruop-1.png" alt="">                                                
                                </div>
                            </div>
                        </div>                            
                    </div>
                            ...
                            <div class="col-md-12 col-lg-5 col-xl-4 offset-md-0 offset-lg-8 offset-xl-7">
                                <div class="decide-section-text-box">
                                    <h2 class="decide-section-heading">
                                        Decide por <span class="contrast-word">More</span>
                                    </h2>
                                    <p class="standard-text decide-section-text">
                                        Aprovecha más tus espacios. <span class="bold-word">More</span> es la
                                        propuesta innovadora de viviendas con
                                        flexibilidad y dinamismo, en increíbles 
                                        modalidades con las que podrás incluso
                                        rentar a través del sistema lock off.
                                    </p>                                
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-2 offset-9 offset-sm-10 offset-md-9 offset-lg-3">
                                <div class="polygon-group-wrapper">
                                    <img class="polygon-group" src="assets/img/polygons/triangle-gruop-2.png" alt="">                                                                                    
                                </div>
                            </div>
                        </div>                            
                    </div>
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6 order-2 order-lg-1 d-flex justify-content-center justify-content-lg-end">
                                                <div class="storey-section-tab-image-box">
                                                    <img class="storey-section-tab-image" src="assets/img/storey/ModeloSKY.png" alt="">
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="modelo-up" role="tabpanel" aria-labelledby="modelo-up-tab">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6 order-2 order-lg-1 d-flex justify-content-center justify-content-lg-end">
                                                <div class="storey-section-tab-image-box">
                                                    <img class="storey-section-tab-image" src="assets/img/storey/ModeloUP.png" alt="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-5 offset-0 offset-lg-1 order-1 order-lg-2 d-flex justify-content-center justify-content-lg-start">
                                                <div class="storey-section-tab-text-box">
                                    ...
                                    <div class="tab-pane fade show active" id="modelo-high" role="tabpanel" aria-labelledby="modelo-high-tab">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6 order-2 order-lg-1 d-flex justify-content-center justify-content-lg-end">
                                                <div class="storey-section-tab-image-box">
                                                    <img class="storey-section-tab-image" src="assets/img/storey/ModeloHIGH.png" alt="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-5 offset-0 offset-lg-1 order-1 order-lg-2 d-flex justify-content-center justify-content-lg-start">
                                                <div class="storey-section-tab-text-box">
                                    ...
                                    <div class="tab-pane fade" id="modelo-plus" role="tabpanel" aria-labelledby="modelo-plus-tab">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6 order-2 order-lg-1 d-flex justify-content-center justify-content-lg-end">
                                                <div class="storey-section-tab-image-box">
                                                    <img class="storey-section-tab-image" src="assets/img/storey/ModeloPLUS.png" alt="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-5 offset-0 offset-lg-1 order-1 order-lg-2 d-flex justify-content-center justify-content-lg-start">
                                                <div class="storey-section-tab-text-box">
                                    ...
                                    <div class="tab-pane fade" id="modelo-ultra" role="tabpanel" aria-labelledby="modelo-ultra-tab">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6 order-2 order-lg-1 d-flex justify-content-center justify-content-lg-end">
                                                <div class="storey-section-tab-image-box">
                                                    <img class="storey-section-tab-image" src="assets/img/storey/ModeloULTRA.png" alt="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-5 offset-0 offset-lg-1 order-1 order-lg-2 d-flex justify-content-center justify-content-lg-start">
                                                <div class="storey-section-tab-text-box">
                ...
                <div class="layer-2">
                    <div class="container">
                        <div class="row">
                            <div class="col-2">
                                <div class="polygon-group-wrapper">
                                    <img class="polygon-group align-self-end" src="assets/img/polygons/triangle-gruop-4.png" alt="">                                                
                                </div>
                            </div>
                            <div class="col-1 offset-md-8 offset-lg-9">
                                <div class="polygon-group-wrapper">
                                    <img class="polygon-group align-self-end" src="assets/img/polygons/triangle-gruop-3.png" alt="">                                                
                                </div>
                            </div>
                        </div>                            
                    </div>
                                ...
                                <div id="amenities-slider" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/Pool.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Pool</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/MultisportsPlace.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Multisports place</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/ZenGarden.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Zen Garden</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/GameRoom.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Game Room</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/PetSpa.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Pet Spa</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/PoolSide.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Pool Lounge</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/Coworking.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Coworking</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/KidsPlayground.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Kid’s Playground</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/Yoga.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Chroma Yoga</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/SocialZone.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Social Zone</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" src="assets/img/cropped/JuiceBar.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Juice Bar</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/Gym.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Gym</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/ToolLibrary.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="amenitie-label">Tool Library</h5>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="assets/img/cropped/Lobby.png" alt="">
                                            <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-2 offset-lg-4 offset-xl-6">
                                <div class="polygon-group-wrapper">
                                    <img class="polygon-group" src="assets/img/polygons/triangle-gruop-5.png" alt="">                                                                                    
                                </div>
                            </div>
                        </div>                            
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-2 offset-8 offset-lg-4">
                                <div class="polygon-group-wrapper">
                                    <img class="polygon-group" src="assets/img/polygons/triangle-gruop-6.png" alt="">                                                                                    
                                </div>
                            </div>
                        </div>                            
                    </div>
            ...
            <div class="container">
                <div class="row align-content-center">
                    <div class="col-12 d-flex justify-content-between">
                        <img class="footer-brand" src="assets/img/logos/footer-logo.png" alt="">
                        <p class="footer-text">
                            Vía Argentina PH More, PA.</br>
                            T. 398-1122
                        </p>
                        <img class="partner-logo" src="assets/img/logos/partner-logo.png" alt="">
                    </div>
                </div>
            </div>
        </footer>
